public class OnlineCoachingPlan extends MembershipPlan implements RemoteAccess {
    ...
    public String toString() {
        return super.toString() + String.format(", videoConsultations=%d, mealPlanIncluded=%b, recordedLibraryAccess=%b", videoConsultations, mealPlanIncluded, recordedLibraryAccess);
    }
}
